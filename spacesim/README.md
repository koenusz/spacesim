...
- spacesim-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- spacesim-ui: main application module, development time
- spacesim-production: module that produces a production mode WAR for deployment
